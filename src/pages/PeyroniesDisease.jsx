    ...
    <div className="min-h-screen bg-[#F4FAFB] pt-24 pb-16">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative w-full h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-lg mb-10 animate-fade-in-up">
          <img
            src="/images/treatments/peyronies-disease/peyronies-disease-banner.jpg"
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="p-display text-3xl md:text-5xl font-bold text-white drop-shadow-lg">
                  Peyronie's <span className="text-[#7FE0F0]">Disease</span>
                </h1>
                <p className="p-body text-sm text-white/80 mt-1">
                  Understanding penile curvature & treatment options
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#5DA9B3]/20 p-6 md:p-8 card-hover animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              <h2 className="p-display text-xl font-semibold text-[#16232E] mb-3">What is Peyronie's Disease?</h2>
              <p className="p-body text-[#4A5A66] leading-relaxed text-sm">
                Curvature of the penis is an abnormal bend in the penis that occurs during erection. It is also called <strong>Peyronie's disease</strong>.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#5DA9B3]/20 p-6 md:p-8 card-hover animate-fade-in-up" style={{ animationDelay: '150ms' }}>
              ...
              <ul className="mt-3 space-y-2">
                <li className="flex items-start gap-2 p-body text-sm text-[#4A5A66] bg-[#F4FAFB] rounded-lg px-3 py-2">
                  ...
                  <span>Fracture of the penis can lead to this condition</span>
                </li>
                <li className="flex items-start gap-2 p-body text-sm text-[#4A5A66] bg-[#F4FAFB] rounded-lg px-3 py-2">
                  <FaCheckCircle className="text-[#5DA9B3] shrink-0 mt-0.5" size={10} />
                  <span>Higher risk after surgery or radiation treatment for <strong>prostate cancer</strong></span>
                </li>
                <li className="flex items-start gap-2 p-body text-sm text-[#4A5A66] bg-[#F4FAFB] rounded-lg px-3 py-2">
                  <FaCheckCircle className="text-[#5DA9B3] shrink-0 mt-0.5" size={10} />
                  <span>Uncommon — affects men ages <strong>40-60</strong> and older</span>
                </li>
                <li className="flex items-start gap-2 p-body text-sm text-[#4A5A66] bg-[#F4FAFB] rounded-lg px-3 py-2">
                  <FaCheckCircle className="text-[#5DA9B3] shrink-0 mt-0.5" size={10} />
                  <span>May be associated with <strong>Dupuytren's contracture</strong></span>
                </li>
                <li className="flex items-start gap-2 p-body text-sm text-[#4A5A66] bg-[#F4FAFB] rounded-lg px-3 py-2">
                  <FaCheckCircle className="text-[#F77F00] shrink-0 mt-0.5" size={10} />
                  <span>May be inherited — certain immune cell markers found</span>
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#F4FAFB] rounded-xl p-4 border border-[#5DA9B3]/20">
                  <h3 className="p-display text-base font-semibold text-[#5DA9B3] flex items-center gap-2">
                    <FaPills size={14} /> Vitamin E Supplementation
                  </h3>
                  <p className="p-body text-sm text-[#5B6B76] leading-relaxed mt-1">
                    Vitamin E has antioxidant properties and may help with scar prevention, hinder scar tissue building up, and reduce inflammation.
                  </p>
                </div>
                ...
                <div className="bg-[#F4FAFB] rounded-xl p-4 border border-[#F77F00]/20">
                  <h3 className="p-display text-base font-semibold text-[#F77F00] flex items-center gap-2">
                    <FaFlask size={14} /> Newer Agents of Interest
                  </h3>
                  <ul className="mt-2 space-y-1">
                    {[
                      'Potassium para-aminobenzoate (Potaba)',
                      'Pentoxifylline (TGFβ1 inhibition)',
                      'Coenzyme Q10',
                      'Acetyl L-carnitine, Propionyl L-carnitine',
                      'L-arginine, Sildenafil',
                      'Interferon-alpha-2b (early stages)',
                    ].map((item, idx) => (
                ...
                <div className="bg-[#F4FAFB] rounded-xl p-4 border border-[#5DA9B3]/20">
                  <h3 className="p-display text-base font-semibold text-[#5DA9B3] flex items-center gap-2">
                    <FaCut size={14} /> Surgical Options
                  </h3>
                  <ul className="mt-2 space-y-1">
                    <li className="flex items-start gap-2 p-body text-sm text-[#5B6B76]">
                      <FaCheckCircle className="text-[#5DA9B3] shrink-0 mt-0.5" size={10} />
                      <strong>Plaque excision & Fascia lata patch</strong>
                    </li>
                    <li className="flex items-start gap-2 p-body text-sm text-[#5B6B76]">
                      <FaCheckCircle className="text-[#5DA9B3] shrink-0 mt-0.5" size={10} />
                      <strong>Nesbit procedure</strong> — removing/altered tissue opposite the plaque
                    </li>
                    <li className="flex items-start gap-2 p-body text-sm text-[#5B6B76]">
                      <FaCheckCircle className="text-[#5DA9B3] shrink-0 mt-0.5" size={10} />
                      <strong>Penile prosthesis implantation</strong> — for men with ED
                    </li>
                  </ul>
                  <p className="p-body text-sm text-[#5B6B76] leading-relaxed mt-2">
                    Most doctors prefer surgery only for severe curvature that prevents sexual intercourse.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#5DA9B3]/20 p-6 card-hover animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              ...
              <dl className="space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-2 bg-[#F4FAFB] rounded-lg px-4 py-3">
                  ...
                  <span className="p-body text-sm font-medium text-[#16232E]">Penile curvature</span>
                </div>
                <div className="flex flex-wrap items-center justify-between gap-2 bg-[#F4FAFB] rounded-lg px-4 py-3">
                  <span className="p-body text-xs font-semibold text-[#8A97A0] uppercase tracking-wide">Age group</span>
                  <span className="p-body text-sm font-medium text-[#16232E]">40-60 years</span>
                </div>
                <div className="flex flex-wrap items-center justify-between gap-2 bg-[#F4FAFB] rounded-lg px-4 py-3">
                  <span className="p-body text-xs font-semibold text-[#8A97A0] uppercase tracking-wide">Key symptom</span>
                  <span className="p-body text-sm font-medium text-[#16232E]">Bend in penis during erection</span>
                </div>
              </dl>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#5DA9B3]/20 p-6 card-hover animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              ...
              <p className="p-body text-sm text-[#5B6B76] leading-relaxed">
                If you notice abnormal penile curvature, pain during erection, or difficulty with intercourse, consult a specialist.
              </p>
            </div>
...
export default PeyroniesDisease;