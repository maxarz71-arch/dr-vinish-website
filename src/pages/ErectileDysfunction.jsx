    ...
    <div className="min-h-screen bg-[#F4FAFB] pt-24 pb-16">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative w-full h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-lg mb-10 animate-fade-in-up">
          <img
            src="/images/treatments/erectile-dysfunction/erectile-dysfunction-banner.jpg"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#5DA9B3]/20 p-6 md:p-8 card-hover animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              <h2 className="p-display text-xl font-semibold text-[#16232E] mb-3">What is Erectile Dysfunction?</h2>
              ...
              <p className="p-body text-[#4A5A66] leading-relaxed text-sm mt-3">
                Not all male sexual problems are caused by ED. Other types of male sexual dysfunction include: premature ejaculation, delayed or absent ejaculation, and lack of interest in sex.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#5DA9B3]/20 p-6 md:p-8 card-hover animate-fade-in-up" style={{ animationDelay: '150ms' }}>
              ...
              <div className="mt-4 bg-[#F4FAFB] rounded-xl p-4 border border-[#5DA9B3]/20">
                <h3 className="p-display text-base font-semibold text-[#5DA9B3] flex items-center gap-2">
                  <FaInfoCircle size={14} /> Other Related Sexual Disorders
                </h3>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#5DA9B3]/20 p-6 md:p-8 card-hover animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              ...
              <p className="p-body text-[#4A5A66] leading-relaxed text-sm">
                There are many possible causes for ED, and they can include both emotional and physical disorders.
              </p>
              
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  { icon: FaHeartbeat, text: 'Cardiovascular disease' },
                  { icon: FaHeartbeat, text: 'Diabetes' },
                  { icon: FaHeartbeat, text: 'Hypertension' },
                  { icon: FaHeartbeat, text: 'Hyperlipidemia' },
                  { icon: FaProcedures, text: 'Damage from cancer or surgery' },
                  { icon: FaExclamationTriangle, text: 'Injuries' },
                  { icon: FaBolt, text: 'Obesity or being overweight' },
                  { icon: FaClock, text: 'Increased age' },
                  { icon: FaBrain, text: 'Stress' },
                  { icon: FaBrain, text: 'Anxiety' },
                  { icon: FaInfoCircle, text: 'Relationship problems' },
                  { icon: FaSmoking, text: 'Smoking' },
                  { icon: FaFlask, text: 'Alcohol use' },
                  { icon: FaSyringe, text: 'Drug use' },
                ].map((cause, idx) => {
              ...
              <p className="p-body text-[#4A5A66] leading-relaxed text-sm mt-4">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#5DA9B3]/20 p-6 card-hover animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              ...
              <dl className="space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-2 bg-[#F4FAFB] rounded-lg px-4 py-3">
                  ...
                  <span className="p-body text-sm font-medium text-[#16232E]">Inability to get/keep erection</span>
                </div>
                <div className="flex flex-wrap items-center justify-between gap-2 bg-[#F4FAFB] rounded-lg px-4 py-3">
                  <span className="p-body text-xs font-semibold text-[#8A97A0] uppercase tracking-wide">Occasional</span>
                  <span className="p-body text-sm font-medium text-[#16232E]">Common during stress</span>
                </div>
                <div className="flex flex-wrap items-center justify-between gap-2 bg-[#F4FAFB] rounded-lg px-4 py-3">
                  <span className="p-body text-xs font-semibold text-[#8A97A0] uppercase tracking-wide">When to see doctor</span>
                  <span className="p-body text-sm font-medium text-[#16232E]">2+ months</span>
                </div>
              </dl>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#5DA9B3]/20 p-6 card-hover animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              ...
              <p className="p-body text-sm text-[#5B6B76] leading-relaxed">
                You should talk to your doctor if you have any of these symptoms, especially if they've lasted for two or more months.
              </p>
            </div>
